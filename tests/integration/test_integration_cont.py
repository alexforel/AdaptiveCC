...
class test_IntegrationContinuous(unittest.TestCase):
    ...
    def test_adaptive_partitioners(self, init_part, split_method,
        ...
        self.assertAlmostEqual(method.vUB, self.v)
